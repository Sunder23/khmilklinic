						...
						?>
                         <ul class="page_testimonials_list">
              	           <li class="<?php if(!$term->term_id) echo 'active'; ?>">
								<a href="/vidguky">Всі відгуки</a>
							</li>
							  <?php
							  if ($categories) :
								foreach ($categories as $cat) : ?>
								   <li class="<?php if(get_query_var('term') == $cat->slug) { ?>active<?php }?>">
						...
						?>		
                                ...
                                <div class="page_testimonials_popup_swiper swiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="page_testimonials_popup_card page_testimonials_popup_card_image">
                                                <div class="page_testimonials_popup_card_wrapper">
                                                    <div class="page_testimonials_popup_card_video video_taxonomy"><?php the_field('video', $post_id)?></div>
                                                </div>
                                            </div>
                                        </div>
										<?php endif;?>
                                    ...
                                    <div
										...
										<div class='page_testimonials_popup_arrows_span'>Свайпай, щоб подивитись інші відгуки</div>
                                        <div
